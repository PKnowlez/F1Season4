...
def article():
    ...
    st.markdown('''
                ...
                But first, the league's first ever protest vote has concluded. Regulation 9 states that a driver can protest an official ruling within 24 hours of the ruling being released. To overturn the ruling, the league needs a super majority, or in other words 2/3rds of the vote. This amounts to 10 votes with the current league size of 14 drivers. <br><br>
